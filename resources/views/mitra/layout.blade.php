    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="dashboard-mahasiswa.html" class="">
                <img src="{{ asset('img/sim-horizontal-white.png') }}" alt="" class="e " style="height: 75px;">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('img/sim-vertical-orange.png') }}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
